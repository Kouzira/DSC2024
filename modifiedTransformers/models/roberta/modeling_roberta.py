...
class RobertaModel(RobertaPreTrainedModel):
    ...
    def forward(
        ...
        if image_feature_input.size() != embedding_output.size():
            raise ValueError(f"Image feature shape must match text embedding shape.\n\
                            Expected: {embedding_output.size()}\n\
                            Got: {image_feature_input.size()}")
